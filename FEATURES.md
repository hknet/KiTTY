...
- **Other features**
  ...
  - [kscp and WinSCP integration](#kscp-and-winscp-integration)
...
**How to enable:** kscp ships beside kitty.exe and is found at every start; the paths to WinSCP and FileZilla, the transfer port, the global download and upload folders and the notification switch are on **Application > KiTTY++ Settings > Transfers & Tools**. Per session: the protocol and kscp options on **Connection > SSH > KSCP**, WinSCP's and FileZilla's own options on their panels beside it, where files go on **Connection > Transfers**.

![kscp and WinSCP integration](docs/features/img/config_winscp_integration.jpg)
