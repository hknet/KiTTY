...
wixl -v -a x64 -o "$OUT/KiTTY-0.84.0.1-beta-x64-system.msi" kitty-system.wxs 2>&1 | tail -2

echo "=== per-user (no UAC) ==="
wixl -v -a x64 -o "$OUT/KiTTY-0.84.0.1-beta-x64-peruser.msi" kitty-peruser.wxs 2>&1 | tail -2

echo "=== built ==="
ls -la "$OUT"/KiTTY-0.84.0.1-beta-x64-*.msi
