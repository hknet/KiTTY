...
> ✅ **First stable release** (`0.84.1.0`). It builds clean and ~44 KiTTY features are verified,
> including a new OpenSSH-style **post-quantum key-exchange warning**. Please still read the known
> issues below.
...
Current release — **[KiTTY 0.84.1.0](https://github.com/hknet/KiTTY/releases/tag/kitty-0.84.1.0)**:

| Download | Use it when |
|---|---|
| **[Installer — per-user (no admin)](https://github.com/hknet/KiTTY/releases/download/kitty-0.84.1.0/KiTTY-0.84.1.0-x64-peruser.msi)** | **Recommended.** Installs for your user only, **no UAC prompt** (`%LOCALAPPDATA%\Programs\KiTTY`). |
| **[Installer — system-wide](https://github.com/hknet/KiTTY/releases/download/kitty-0.84.1.0/KiTTY-0.84.1.0-x64-system.msi)** | All users, into `Program Files` (requires admin). |
| **[Portable ZIP](https://github.com/hknet/KiTTY/releases/download/kitty-0.84.1.0/kitty-0.84.1.0.zip)** | No install — run from a folder or USB stick. Includes `kitty_portable.exe` and all command-line tools. |
