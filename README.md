...
> ⚠️ **This is a public _beta_** (`0.84.0.13-beta`). It builds clean and ~43 KiTTY features are
...
Current beta — **[KiTTY 0.84.0.13-beta](https://github.com/hknet/KiTTY/releases/tag/kitty-0.84.0.13-beta)**:

| Download | Use it when |
|---|---|
| **[Installer — per-user (no admin)](https://github.com/hknet/KiTTY/releases/download/kitty-0.84.0.13-beta/KiTTY-0.84.0.13-beta-x64-peruser.msi)** | **Recommended.** Installs for your user only, **no UAC prompt** (`%LOCALAPPDATA%\Programs\KiTTY`). |
| **[Installer — system-wide](https://github.com/hknet/KiTTY/releases/download/kitty-0.84.0.13-beta/KiTTY-0.84.0.13-beta-x64-system.msi)** | All users, into `Program Files` (requires admin). |
| **[Portable ZIP](https://github.com/hknet/KiTTY/releases/download/kitty-0.84.0.13-beta/kitty-0.84.0.13-beta.zip)** | No install — run from a folder or USB stick. Includes `kitty_portable.exe` and all command-line tools. |
