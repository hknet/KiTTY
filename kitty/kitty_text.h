...
/* Application/Security/Applications (kitty_config_apps.c) */
#define KT_APPS_TITLE                                "Applications"
#define KT_APPS_INTRO                                "The Apps that are part of this package and if they check out."
#define KT_APPS_COL_HEAD                             "File\tVersion\tSignature\tStamp\tVerdict"
#define KT_APPS_SIG_OURS                             "ours"
#define KT_APPS_SIG_OTHER                            "other signer"
#define KT_APPS_SIG_UNSIGNED                         "unsigned"
#define KT_APPS_SIG_MODIFIED                         "modified"
#define KT_APPS_SIG_CANNOT                           "cannot judge"
#define KT_APPS_STAMP_VALID                          "valid"
#define KT_APPS_STAMP_MODIFIED                       "modified"
#define KT_APPS_STAMP_NONE                           "no stamp"
#define KT_APPS_STAMP_OTHER_RELEASE                  "other release"
#define KT_APPS_STAMP_NOKEY                          "no key in this build"
#define KT_APPS_STAMP_CANNOT                         "cannot read"
#define KT_APPS_V_AUTH                               "authenticated"
#define KT_APPS_V_WARN                               "WARNING"
#define KT_APPS_V_UNVERIFIED                         "unverified"
#define KT_APPS_STRANGER                             "not part of KiTTY++"
#define KT_APPS_BANNER_CHECKING                      "Checking %d of %d..."
#define KT_APPS_BANNER_OK                            "%d files, all authenticated."
#define KT_APPS_BANNER_WARN                          "WARNING: %d of %d could not be authenticated - see the red rows."
#define KT_APPS_BANNER_CANNOT                        "%d files; this Windows cannot judge %d of them."
#define KT_APPS_BANNER_NOTHING                       "%d files; this build carries no signature and no stamp, so nothing could be checked."
#define KT_APPS_BANNER_STRANGERS                     "%d other programs in this folder are not part of KiTTY++."
#define KT_APPS_COPY                                 "Copy"
#define KT_APPS_VERIFY                               "Verify again"
#define KT_APPS_COPIED                               "The table is on the clipboard."
#define KT_APPS_NOTE                                 "A red row is a file of ours that was changed or is signed by someone else. See Help for what each column checks."
#define KT_APPS_DETAIL_NONE                          "Select a file for its details. The header row lists any other programs found in the folder."
#define KT_APPS_DETAIL_PENDING                       "Not checked yet."
#define KT_APPS_DETAIL_STRANGERS                     "%d other programs in this folder, not part of KiTTY++ and not checked:"
#define KT_APPS_DETAIL_FILE                          "File: %s"
#define KT_APPS_DETAIL_SIZE                          "Size: %lu bytes"
#define KT_APPS_DETAIL_VERSION                       "Version: %s"
#define KT_APPS_DETAIL_SIGNATURE                     "Signature: %s (signer: %s)"
#define KT_APPS_DETAIL_STAMP                         "Stamp: %s (SHA-256: %s)"
#define KT_APPS_DETAIL_VERDICT                       "Verdict: %s - %s"
#define KT_APPS_WHY_SIG_MODIFIED                     "the file was changed after it was signed"
#define KT_APPS_WHY_SIG_OTHER                        "the signature is someone else's"
#define KT_APPS_WHY_SIG_MISSING                      "this KiTTY++ is signed and the file is not"
#define KT_APPS_WHY_STAMP_MISSING                    "this KiTTY++ carries a release stamp and the file does not"
#define KT_APPS_WHY_STAMP_FAILED                     "the release stamp does not match the file"
#define KT_APPS_WHY_VERSION                          "the file version differs from this KiTTY++"
#define KT_APPS_WHY_OK                               "every check this KiTTY++ requires passed (%s)"
#define KT_APPS_WHY_UNVERIFIED                       "nothing here could judge this file"
#define KT_APPS_REQ_BOTH                             "signature and stamp"
#define KT_APPS_REQ_SIG                              "signature"
#define KT_APPS_REQ_STAMP                            "stamp"
#define KT_APPS_REQ_NONE                             "no check required by this build"
#define KT_APPS_EVENTLOG                             "KiTTY++ Applications: %s - %s"
...
#define KT_KSET_SC_ACTIONS                           "Shortcuts for KiTTY++ actions"
#define KT_KSET_SC_ACTIONS_HEAD                      "Action\tKey"
#define KT_KSET_SC_AUTOTEXT_TITLE                    "AutoText"
#define KT_KSET_SC_AUTOTEXT                          "AutoText Shortcuts"
#define KT_KSET_SC_AUTOTEXT_HEAD                     "Key\tText"
/* Under the AutoText buttons: the trailing-backslash rule of the send
 * routine, and where the rest is. */
#define KT_KSET_SC_AUTOTEXT_NOTE                     "End your text with '\\' to not send <enter> after the text."
#define KT_KSET_SC_AUTOTEXT_NOTE_HELP                "The help has the details."
#define KT_KSET_SC_KEY                               "Key:"
#define KT_KSET_SC_TEXT                              "Text to type:"
#define KT_KSET_SC_KEY_HINT                          "Press the keys. Backspace clears."
#define KT_KSET_SC_SAVE                              "Save"
#define KT_KSET_SC_DEFAULT                           "Default"
#define KT_KSET_SC_DELETE                            "Delete"
#define KT_KSET_SC_NEW                               "New"
#define KT_KSET_SC_USERCMD_NOTE                      "%s is also user command %d; that command keeps its menu entry only."
#define KT_KSET_SC_USED_BY_ACTION                    "%s is already used by %s."
#define KT_KSET_SC_USED_BY_TEXT                      "%s is already used by a key combination that types text."
#define KT_KSET_SC_RESERVED                          "%s is reserved by KiTTY."
#define KT_KSET_SC_ALTF4                             "Alt+F4 closes the window and cannot be a shortcut."
#define KT_KSET_SC_TEXT_EMPTY                        "Enter the text this key should type."
#define KT_KSET_SC_READONLY                          "kitty.ini is read-only; the shortcut was not saved."
#define KT_KSET_SC_NO_INI                            "There is no kitty.ini; shortcuts need one."

/* The [Shortcuts] actions as the editor lists them and the help names them
 * (kitty_shortcuts.c): the menu entries keep the menu wording. */
#define KT_SC_ACT_AUTOCOMMAND                        "Send the automatic command"
#define KT_SC_ACT_CHANGESETTINGS                     "Change Settings"
#define KT_SC_ACT_CLEARLOGFILE                       "Clear the log file"
#define KT_SC_ACT_CLEARSCROLLBACK                    "Clear scrollback"
#define KT_SC_ACT_CLOSERESTART                       "Close and restart the session"
#define KT_SC_ACT_COMMAND                            "Run a command"
#define KT_SC_ACT_COPYALL                            "Copy all to clipboard"
#define KT_SC_ACT_DUPLICATE                          "Duplicate the session"
#define KT_SC_ACT_EDITOR                             "Open the editor"
#define KT_SC_ACT_EDITORCLIPBOARD                    "Open the editor with the clipboard"
#define KT_SC_ACT_EVENTLOG                           "Event Log"
#define KT_SC_ACT_FILEZILLA                          "Start FileZilla"
#define KT_SC_ACT_FONTBLACKANDWHITE                  "Font: black and white"
#define KT_SC_ACT_FONTDOWN                           "Font size: smaller"
#define KT_SC_ACT_FONTNEGATIVE                       "Font: negative"
#define KT_SC_ACT_FONTRESET                          "Font size: reset"
#define KT_SC_ACT_FONTUP                             "Font size: larger"
#define KT_SC_ACT_FULLSCREEN                         "Full screen"
#define KT_SC_ACT_GETFILE                            "Get File (kscp)"
#define KT_SC_ACT_IMAGECHANGE                        "Change the background image"
#define KT_SC_ACT_INPUT                              "Send to all windows"
#define KT_SC_ACT_INPUTM                             "Send to all windows (mode)"
#define KT_SC_ACT_KEYEXCHANGE                        "Repeat key exchange"
#define KT_SC_ACT_OPENLOGFILE                        "Open the log file"
#define KT_SC_ACT_OPENNEW                            "New session"
#define KT_SC_ACT_OPENNEWCURRENT                     "New session with these settings"
#define KT_SC_ACT_PRINT                              "Print the screen"
#define KT_SC_ACT_PRINTALL                           "Print all"
#define KT_SC_ACT_PROTECT                            "Protect the window"
#define KT_SC_ACT_RESETTERMINAL                      "Reset the terminal"
#define KT_SC_ACT_ROLLUP                             "Roll the window up"
#define KT_SC_ACT_SCRIPT                             "Send a script file"
#define KT_SC_ACT_SENDFILE                           "Send File (kscp)"
...
#define KT_SC_ACT_VISIBLE                            "Always on top"
#define KT_SC_ACT_WINSCP                             "Start WinSCP"
