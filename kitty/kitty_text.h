...
#define KT_APPS_BANNER_WARN                          "WARNING: %d of %d not authenticated - see the red rows."
#define KT_APPS_BANNER_CANNOT                        "%d files; this Windows cannot judge %d of them."
#define KT_APPS_BANNER_NOTHING                       "%d files, none checked: this build has no signature and no stamp."
#define KT_APPS_BANNER_STRANGERS                     "Not part of KiTTY++: %d other program(s) in this folder."
